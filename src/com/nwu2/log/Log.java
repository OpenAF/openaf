...
public class Log {
	...
	public void log(java.util.logging.Level level, String message) {
		if (level == Level.WARNING) log(com.nwu2.log.Log.Type.DEBUG, message);
		if (level == Level.SEVERE) log(com.nwu2.log.Log.Type.ERROR, message);
		if (level == Level.INFO) log(com.nwu2.log.Log.Type.INFO, message);
		if (level == Level.FINE) log(com.nwu2.log.Log.Type.FINE, message);
	}
