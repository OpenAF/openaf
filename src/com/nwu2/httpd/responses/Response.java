...
public abstract class Response {
	 ...
	 * @return
	 */
	public com.nwu2.httpd.NanoHTTPD.Response getResponse() {
		com.nwu2.httpd.NanoHTTPD.Response response = new com.nwu2.httpd.NanoHTTPD.Response(status, mimeType, data, size);
