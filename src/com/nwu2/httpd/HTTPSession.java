...
import com.nwu2.httpd.NanoHTTPD.Method;
import com.nwu2.log.Log;
import com.nwu2.log.Log.Type;
...
public class HTTPSession {
	...
	public static com.nwu2.httpd.NanoHTTPD.Response serve(IHTTPd httpd, Log log, String uri, Method method, Map<String, String> headers, Map<String, String> parms,
		...
		if (httpd.getURIresponses().containsKey(registeredUri)) {
			com.nwu2.httpd.responses.Response response = null;
			...
			try {
				...
				response = (com.nwu2.httpd.responses.Response) c.newInstance(httpd, registeredUri, httpd.getURIProps(registeredUri));
