...
//	}
	...
	public class JSMap implements wedo.openaf.JSEngine.JSMap {
		Scriptable no;
		Scriptable parentNo;
	...
	public class JSList extends wedo.openaf.JSEngine.JSList {
		Scriptable parentNo;
	...
	@Override
	public wedo.openaf.JSEngine.JSList getNewList(Object parent) {
		if (parent == null) 
			return new JSList();
		else
	...
	@Override
	public wedo.openaf.JSEngine.JSMap getNewMap(Object parent) {
		if (parent == null)
			return new JSMap();
		else
